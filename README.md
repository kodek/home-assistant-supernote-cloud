...
1. **Official Cloud**: By default, it connects to the official, original Supernote Cloud service (using your standard Supernote credentials).
2. **Self-Hosted Server**: If you want complete data privacy and local ownership, it integrates seamlessly with **[allenporter/supernote](https://github.com/allenporter/supernote)**, a lightweight, SQLite-backed private cloud server.
...
3. Enter your credentials (username/phone number and password).
4. By default, the **Supernote Private Cloud URL** is set to the official cloud URL. If you are using a self-hosted server, change this to your server's local URL.
5. Follow the setup flow (including entering the SMS verification code if applicable).
